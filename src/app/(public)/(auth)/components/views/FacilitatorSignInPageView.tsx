...
function FacilitatorSignInPageView() {
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-amber-500/15 border border-amber-500/30">
                                <EngineeringIcon className="text-amber-500" fontSize="small" />
                            </div>
                            <div>
                                <Typography variant="h5" className="font-bold">Facilitator Login</Typography>
                                <Typography variant="caption" className="text-gray-400">Sign in to your facilitator account</Typography>
                            </div>
                        </div>
                    </div>

                    <JwtSignInForm restrictedRole="facilitator" />
                </div>
            </Paper>
...
export default FacilitatorSignInPageView;
