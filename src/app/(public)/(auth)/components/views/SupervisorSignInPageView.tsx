...
function SupervisorSignInPageView() {
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-purple-500/15 border border-purple-500/30">
                                <SupervisorAccountIcon className="text-purple-500" fontSize="small" />
                            </div>
                            <div>
                                <Typography variant="h5" className="font-bold">Supervisor Login</Typography>
                                <Typography variant="caption" className="text-gray-400">Sign in to your supervisor account</Typography>
                            </div>
                        </div>
                    </div>
...
export default SupervisorSignInPageView;
